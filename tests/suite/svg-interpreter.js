  ...
  QUnit.test('Two.interpret', function(assert) {
    ...
    (function() {
      ...
      QUnit.Utils.get('./images/interpretation/K.svg', function(resp) {
        ...
        var answer = {"children":[{"vertices":[{"x":416.146,"y":350,"command":"M","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":0,"y":0}}},{"x":415.862,"y":650,"command":"L","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":0,"y":0}}}],"rotation":0,"scale":1},{"vertices":[{"x":570.858,"y":350,"command":"M","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":0,"y":0}}},{"x":415.961,"y":544.669,"command":"L","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":0,"y":0}}}],"rotation":0,"scale":1},{"vertices":[{"x":469.29,"y":477.828,"command":"M","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":0,"y":0}}},{"x":584.138,"y":650,"command":"L","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":0,"y":0}}}],"rotation":0,"scale":1}],"translation":{"x":200,"y":200},"rotation":0,"scale":1,"opacity":1,"className":"","mask":null};
        var svg = QUnit.Utils.textToDOM(resp)[0];
        var shape = two.interpret(svg).center();
    ...
    (function() {
      ...
      QUnit.Utils.get('./images/interpretation/ellipse.svg', function(resp) {
        ...
        var answer = {"children":[{"vertices":[{"x":150,"y":0,"command":"M","relative":true,"controls":{"left":{"x":0,"y":0},"right":{"x":5.072653133236334e-15,"y":42.46904040773852}}},{"x":9.184850993605149e-15,"y":76.897,"command":"C","relative":true,"controls":{"left":{"x":82.842712474619,"y":0},"right":{"x":-82.842712474619,"y":5.200957439819658e-15}}},{"x":-150,"y":9.417166491403402e-15,"command":"C","relative":true,"controls":{"left":{"x":5.072653133236334e-15,"y":42.46904040773852},"right":{"x":-1.5217959399709e-14,"y":-42.46904040773852}}},{"x":-2.7554552980815446e-14,"y":-76.897,"command":"C","relative":true,"controls":{"left":{"x":-82.842712474619,"y":5.200957439819658e-15},"right":{"x":82.842712474619,"y":-1.0401914879639316e-14}}},{"x":150,"y":-1.8834332982806805e-14,"command":"C","relative":true,"controls":{"left":{"x":-1.5217959399709e-14,"y":-42.46904040773852},"right":{"x":0,"y":0}}}],"rotation":0,"scale":1}],"translation":{"x":200,"y":200},"rotation":0,"scale":1,"opacity":1,"className":"","mask":null};
        var svg = QUnit.Utils.textToDOM(resp)[0];
        var shape = two.interpret(svg).center();
